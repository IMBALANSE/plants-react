...
const Service = () => {
  ...
  useEffect(() => {
    ...
    const handleFilterClick = (itemBtn) => { //Описание этой функции ниже 
      ...
      setActiveFilters(prevFilters => { // prevFilters это локальный* массив фильтров который виден только внутри этой функ (я так думаю)
